...
/**
 * Based on info on shared element callbacks from https://github.com/googlesamples/android-unsplash and https://github.com/andremion/Louvre
 */
public class SelectedArticleSharedElementCallback extends SharedElementCallback {

    private final List<View> mSharedElementViews;

    public SelectedArticleSharedElementCallback() {
